...
async function main() {
    ...
    // Deploy Presale
    const Presale = await ethers.getContractFactory('ATNPreSale');
    const presale = await Presale.deploy();
    // '0x4AEE7d5CCcb90fBBF2869C091F9eDB0d70B3557a', '0x5749ED765a983660eaEAfe03B9C2Bfe3CCbfc263', '0x60a08d4C9e08a35577D8Bf0Da4cf81f26A66992D', 500000, 10
    console.log("ATNPresale deployed on ", presale.address);
    // presale.initialize('0x4AEE7d5CCcb90fBBF2869C091F9eDB0d70B3557a', '0x5749ED765a983660eaEAfe03B9C2Bfe3CCbfc263', '0x60a08d4C9e08a35577D8Bf0Da4cf81f26A66992D', 500000, 10);
    console.log("ATN Presale initialized")
